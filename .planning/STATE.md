...
**Current focus:** Phase 11 — live-readiness review (post-v1, out of original v1 scope per [PROJECT.md](http://PROJECT.md))
...
|----------|-----------|-------|
| 11-phase v1 ordering (0–10), Phase 11 deferred | [PROJECT.md](http://PROJECT.md) scopes live-readiness review out of v1; matches research [SUMMARY.md](http://SUMMARY.md) proposal | Roadmap |
...
**Next entry point:** Write `[PROMOTION.md](http://PROMOTION.md)` with named numeric promotion criteria → start paper accumulation clock
**Files of record:**

- `.planning/[PROJECT.md](http://PROJECT.md)` — project context, core value, constraints, key decisions
- `.planning/[REQUIREMENTS.md](http://REQUIREMENTS.md)` — 90 v1 requirements with phase traceability
- `.planning/[ROADMAP.md](http://ROADMAP.md)` — 11-phase v1 plan with success criteria
- `.planning/research/[SUMMARY.md](http://SUMMARY.md)` — research synthesis (HIGH confidence)
- `.planning/research/[STACK.md](http://STACK.md)`, `[FEATURES.md](http://FEATURES.md)`, `[ARCHITECTURE.md](http://ARCHITECTURE.md)`, `[PITFALLS.md](http://PITFALLS.md)` — research detail
